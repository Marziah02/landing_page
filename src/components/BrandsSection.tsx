          ...
          {brands.map((brand, index) => (
            <motion.div key={brand.id} variants={item}>
              ...
              >
                ...
                <div className=" hidden md:block z-0 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full border border-cyan-500/30 opacity-0 group-hover:opacity-50 transition-all duration-1000 delay-100 animate-spin [animation-duration:6000ms] [animation-direction:reverse]"></div>
                <div className="hidden md:block z-0 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full border border-sky-500/30 opacity-0 group-hover:opacity-60 transition-all duration-1000 delay-200 animate-spin [animation-duration:4000ms]"></div>
                <div className="hidden md:block z-0 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full border border-indigo-500/30 opacity-0 group-hover:opacity-70 transition-all duration-1000 delay-300 animate-spin [animation-duration:2000ms] [animation-direction:reverse]"></div>
