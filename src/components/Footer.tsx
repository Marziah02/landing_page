	...
	return (
		<footer className="max-w-[2000px] mx-auto bg-background py-12">
			<div className="container mx-auto">
				<div className="grid md:grid-cols-2 gap-12 mb-2 justify-center items-center md:justify-start md:items-start">
					<div className="justify-center items-center flex w-full md:w-auto md:block">
