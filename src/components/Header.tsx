  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-background border-b border-[#DCDCDC] h-[60px]">
      ...
      py-3 z-50 animate-fadeIn  ${
        scrolled
          ? "shadow-lg backdrop-blur-3xl border border-[#DCDCDC] bg-white/20"
          : "shadow-[0_24px_60px_rgba(15,23,42,0.7)] backdrop-blur-xl border border-white/20 bg-gradient-to-b from-white/20 to-white/5"
      }  
    `}
                    //  ${
                    //     scrolled
