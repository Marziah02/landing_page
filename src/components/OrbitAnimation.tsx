...
const OrbitAnimation = () => {
  const icons = [
    ...
    { Icon: Package, radius: 100, duration: 10, color: "#fff" },
    { Icon: Code, radius: 150, duration: 15, color: "hsl(var(--accent))" },
    {
      Icon: Smartphone,
      radius: 200,
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: `
    inset 0 -0.2rem 0.40rem -0.22rem rgba(255, 255, 255, 0.8),
    inset 0 0 0 1rem rgba(255, 255, 255, 0.05),
    inset 0 -0.2rem 0.60rem 0.80rem rgba(255, 255, 255, 0.9),
    0 0.4rem 0.80rem 0 rgba(255, 255, 255, 0.9),
    0 0 1.5rem 0.2rem rgba(133, 36, 159, 0.4),
    0 0 1.8rem 0.4rem rgba(34, 210, 224, 0.3)
  `,
