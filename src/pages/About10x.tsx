...
const MissionSection = () => (
  ...
  >
    ...
    <div className="  mx-auto bg-white grid gap-16 md:gap-0 pb-12">
      <div className="grid md:grid-cols-2 gap-1 pt-12 md:pt-[100px] container">
        <motion.div
          className=""
...
const ValuesSection = () => (
  ...
  >
    {/* max-w-[1600px] */}
    <div className="container  mx-auto ">
      <div className="grid md:grid-cols-2 gap-1 pb-12 pt-12 md:pt-[100px]">
        <motion.div
          className=""
          initial={{ opacity: 0, x: -30 }}
          whileInView={{ opacity: 1, x: 0 }}
      ...
      <div className="bg-[#F2F2F2] p-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1 mb-12 md:mb-0">
