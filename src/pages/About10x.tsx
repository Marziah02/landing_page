...
const MissionVisionSection = () => (
  <motion.section
    ...
    variants={containerVariants}
  >
    <div className="container max-w-[1600px] mx-auto bg-background grid gap-16 md:gap-0">
      ...
      <div className="grid md:grid-cols-2 gap-1 md:pt-[100px]">
        ...
        >
          ...
          >
            To become the world’s leading AI venture studio by launching
            10x-impact products that empower individuals, teams, and businesses
            to achieve more — faster, smarter, and with purpose.
          </p>
        </motion.div>
      </div>
    </div>
