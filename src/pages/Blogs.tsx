...
// --- 1. Header Component ---
const Header = () => (
  <header className="bg-white text-black sticky top-0 z-50 border-b border-[#F2F2F2]">
    <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center space-x-6">
        ...
        <a href="#" className="font-medium text-black border-b-2 border-black">
          Blog
        </a>
        <a href="#" className="font-medium hover:text-gray-700">
          Contact
...
const Footer = () => (
  <footer className="bg-black text-white py-16">
    <motion.div
      className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true, amount: 0.3 }}
      variants={containerVariants}
    >
      <motion.div className="mb-8 md:mb-0 max-w-md" variants={itemVariants}>
        <h3 className="text-2xl font-bold">10xGALAXY</h3>
        <p className="mt-2 text-gray-400">
          10x Galaxy is an AI-powered venture studio focused on building
          high-impact digital products designed to deliver at least 10x returns
          in productivity, growth, and revenue.
        </p>
      </motion.div>
      <motion.div
      ...
      >
        <a
          href="#"
          className="bg-white text-black px-6 py-3 rounded-lg text-sm font-semibold hover:bg-gray-200 transition-colors"
        >
          Join
        </a>
      </motion.div>
    ...
    <motion.div
      className="mt-12 text-center text-gray-500 text-sm border-t border-gray-800 pt-8 max-w-7xl mx-auto"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true, amount: 0.3 }}
      variants={itemVariants}
    >
      &copy; {new Date().getFullYear()} 10x Galaxy. All rights reserved.
    </motion.div>
  </footer>
);
