          ...
          {jobOpenings.map((job, index) => (
            ...
            >
              ...
              <div className="w-full mx-auto h-full border border-gray-200 rounded-xl ">
                <div className="md:flex items-center  bg-white  rounded-xl shadow-sm overflow-hidden h-full md:pl-6 md:pr-0.5">
                  {/* Left section */}
                  <div className="flex-1 h-full px-10 md:px-0 pt-5 md:pt-0">
                  ...
                  {/* Middle section */}
                  <div className="w-64 md:p-6 text-sm text-gray-700  h-full p-10">
                  ...
                  <div className="h-16 w-px bg-gray-200 hidden md:block" />
                  {/* Right section */}
                  <div className="md:w-40 h-full p-6 flex justify-center bg-gradient-to-br hover:bg-gradient-to-bl from-[#22D2E0] to-[#85249F] text-white md:rounded-r-lg">
                    <a
                      target="_blank"
                      rel="noopener noreferrer"
