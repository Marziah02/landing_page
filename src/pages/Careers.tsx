...
const HeroSection = () => (
  <section
    ...
    style={{
      backgroundImage: `url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2970&q=80')`, // Blurred office image
    }}
  >
    ...
    >
      ...
      >
        Driven by curiosity and powered by innovation — join us to shape the
        future of AI.
      </motion.h1>
      <motion.p
      ...
      >
        At 10x Galaxy, your ideas can create real impact.
      </motion.p>
      <motion.div
        className="mt-10"
        variants={itemVariants}
