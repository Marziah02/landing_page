	...
	const jobOpenings = [
		{
			...
			type: "Full-time",
			description:
				"We’re seeking a highly skilled software engineer to design, develop, and optimize scalable applications using modern technologies.",
		},
		{
			...
			type: "Full-time",
			description:
				"Join our marketing team to plan and execute digital campaigns, manage social media, and boost online visibility and engagement.",
		},
		{
			...
			type: "Full-time",
			description:
				"Lead product strategy, collaborate with cross-functional teams, and drive the vision and execution of innovative product experiences.",
		},
	];
