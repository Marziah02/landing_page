    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <motion.div
            variants={itemVariants}
            className="bg-[#F2F2F2] p-8 md:p-12 rounded-xl lg:order-1 md:h-screen shadow-lg font-sans" // Form on left
          >
          ...
          <motion.div
            variants={itemVariants}
            className="lg:order-2 bg-[#F2F2F2] p-8 md:p-12 rounded-xl md:h-screen shadow-lg font-sans"
          >
            {" "}
            {/* Info on right */}
