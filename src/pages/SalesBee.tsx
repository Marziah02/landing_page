...
export default function SalesBee() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-x-hidden bg-[#0A0A0A] font-sans text-white py-12 md:py-0">
      {/* --- BACKGROUND LAYER ---
          Abstract Golden/Yellow Tech Background
      */}
      <div
        className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat transform scale-105 blur-lg opacity-60"
        style={{
          backgroundImage:
      ...
      {/* Hexagon Pattern Overlay (CSS simulated) */}
      <div
      ...
      <div className="relative z-10 w-full max-w-5xl px-4 sm:px-6 flex flex-col items-center text-center">
        ...
        <p className="animate-fade-in delay-100 text-base sm:text-lg md:text-2xl text-gray-300 mb-8 md:mb-12 max-w-3xl leading-relaxed font-light px-2">
          The{" "}
          <span className="text-amber-400 font-semibold">AI-driven CRM</span>{" "}
          designed to automate tracking, engagement, and sales workflows.
        </p>
        ...
        <div className="animate-fade-in delay-300 w-full max-w-xs sm:max-w-md relative group">
          ...
          <p className="text-[10px] md:text-xs text-gray-500 mt-4 text-center font-medium tracking-wide">
            Get early access to the CRM revolution.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Automate data entry & logging",
              icon: <Target size={20} />,
            },
            {
              title: "AI Engagement",
              desc: "Personalized outreach flows",
              icon: <Bot size={20} />,
            },
            {
              title: "Sales Workflows",
              desc: "Auto-close more deals",
      ...
      <footer className="absolute bottom-4 md:bottom-6 w-full text-center z-10 hidden md:block">
        <p className="text-[10px] md:text-xs text-gray-600 uppercase tracking-[0.2em] font-bold hover:text-amber-500 transition-colors cursor-default">
          © 2025 SalesBeeCRM AI. All Rights Reserved.
        </p>
      </footer>
